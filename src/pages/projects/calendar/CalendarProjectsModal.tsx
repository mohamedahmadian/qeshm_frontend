import { CalendarDays, FolderKanban, Handshake, Landmark, Percent, Tags, X } from 'lucide-react'
...
import { DeadlineDaysBadge } from './ProjectCalendarShared'

export function CalendarProjectsModal({
  open,
  title,
  subtitle,
  items,
  ...
  return createPortal(
    ...
    >
      ...
      <section
        role="dialog"
        aria-modal="true"
        aria-labelledby="calendar-projects-modal-title"
      ...
      >
          ...
          <div className="relative flex items-start justify-between gap-3">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <h2
                  id="calendar-projects-modal-title"
        ...
        <div className="min-h-0 flex-1 space-y-3 overflow-y-auto p-4 sm:p-5">
          {!items.length ? <FormEmptyHint>{t('projectCalendar.noDeadlineOnDay')}</FormEmptyHint> : null}
          {items.map((project) => (
            <article
              key={project.id}
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 font-medium text-teal-700" dir="ltr">
                    {project.code}
                  </p>
                </div>
              ...
              <div className="grid gap-2 sm:grid-cols-2">
                <FormFactTile
                  ...
                  value={<span dir="ltr">{project.code}</span>}
                  compact
                  tone="mint"
                />
                <FormFactTile
                ...
                <FormFactTile
                  ...
                  value={
                    (project.operators ?? []).map((item) => item.name).join('، ') || '—'
                  }
